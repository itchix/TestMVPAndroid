...
package com.scrachx.foodfacts.checker.ui.splash;
...
public class SplashActivity extends BaseActivity implements SplashMvpView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.scrachx.foodfacts.checker.R.layout.activity_splash);
    ...
    public void openWalkthroughActivity() {
        Intent intent = WalkthroughActivity.getStartIntent(SplashActivity.this);
        startActivity(intent);
        finish();
    }
