...
public class LoginPresenter<V extends LoginMvpView> extends BasePresenter<V>
    ...
    public void onServerLoginClick(String email, String password) {
        ...
        if (email == null || email.isEmpty()) {
            getMvpView().onError(com.scrachx.foodfacts.checker.R.string.empty_email);
            return;
        }
        if (!CommonUtils.isEmailValid(email)) {
            getMvpView().onError(com.scrachx.foodfacts.checker.R.string.invalid_email);
            return;
        }
        if (password == null || password.isEmpty()) {
            getMvpView().onError(com.scrachx.foodfacts.checker.R.string.empty_password);
            return;
        }
